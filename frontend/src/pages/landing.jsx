        ...
        <div className="page-wrapper">
            ...
            <header className="header">
                <div className="container header-container">
                    <h1 className="logo">Role Alchemy</h1>
                    <nav className="nav">
            ...
            {/* VALUE PROP SECTION */}
            <section id="why-alchemy" className="value-section">
                <div className="container">
                    <h3 className="section-title">Why Role Alchemy?</h3>
                    <p className="section-subtitle">
                        To get interview's it's not about having the skills or education, it's about being able to communicate that in your resume.
                    </p>
